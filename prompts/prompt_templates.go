...
const DefaultAIAnnotatePrompt_CS = "Create a summary for the C# source file in my next message. It should be as brief as possible, without unnecessary language structures. The summary must include the namespace and a bulleted list of declared entities. For each entity you must create a brief description - no more than 1 short sentence.\n\nIf there are comments in the file with notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nNamespace: `<namespace>`\n\nThis file provides <description of what this file is used for, 1 sentence>\n\n- `<entity name>`: <entity type>, <description>, <relationships, if any>, <attributes/annotations, if any>. nested entities:\n  - `<sub entity name>`: <entity type>, <description>, etc."

const DefaultAIAnnotatePrompt_VBNet = "Create a summary for the VB.NET source file in my next message. It should be as brief as possible, without unnecessary language structures. The summary must include the namespace and a bulleted list of declared entities. For each entity you must create a brief description - no more than 1 short sentence.\n\nIf there are comments in the file with notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nNamespace: `<namespace>`\n\nThis file provides <description of what this file is used for, 1 sentence>\n\n- `<entity name>`: <entity type>, <description>, <relationships, if any>, <attributes/annotations, if any>. nested entities:\n  - `<sub entity name>`: <entity type>, <description>, etc."

const DefaultAIAnnotatePrompt_Py3 = "Create a summary for the Python 3 source file in my next message. It should be as brief as possible, without unnecessary language structures. The summary must include the module name and a bulleted list of declared entities. For each entity, provide a brief description - no more than 1 short sentence.\n\nIf there are comments in the file with notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nModule: `<module_name>`\n\nThis file provides <description of what this file is used for, 1 sentence>\n\n- `<entity name>`: <entity type>, <description>, <relationships, if any>. nested entities:\n  - `<sub entity name>`: <entity type>, <description>, etc."
...
const DefaultAIAnnotatePrompt_Generic = "Create a summary for the file in my next message. It should be as brief as possible, without unnecessary language structures. The summary must not include the name or path of the source file.\n\nFollow this template when creating description:\n\nFile format: `<format>`\n\nThis file <description of file, 1 sentence>"
