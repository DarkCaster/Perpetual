...
const DefaultAIAnnotatePrompt_Bash = "Create a summary for the Bash script in my next message. It should be as brief as possible, without unnecessary language structures. The summary must include general description of what the script does and a bulleted list of declared functions, if any. For each function you must create a brief description - no more than 1 short sentence. Also use additional notes in the file contents regarding the summary, if any."
