...
func (p *goPrompts) GetAnnotateConfig() map[string]interface{} {
	...
	result[config.K_AnnotateStage1Prompts] = [][4]string{
		{"(?i)^.*_test\\.go$", defaultAIAnnotatePrompt_Go_Tests, defaultAIAnnotatePrompt_Go_Tests_Short, defaultAIAnnotatePrompt_Go_Tests_Tiny},
		{"(?i)^.*\\.go$", defaultAIAnnotatePrompt_Go, defaultAIAnnotatePrompt_Go_Short, defaultAIAnnotatePrompt_Go_Tiny},
