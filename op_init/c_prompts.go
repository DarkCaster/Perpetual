...
func (p *cPrompts) GetAnnotateConfig() map[string]any {
...
func (p *cPrompts) GetImplementConfig() map[string]any {
...
func (p *cPrompts) GetDocConfig() map[string]any {
...
func (p *cPrompts) GetExplainConfig() map[string]any {
...
func (p *cPrompts) GetProjectConfig() map[string]any {
...
func (p *cPrompts) GetReportConfig() map[string]any {
