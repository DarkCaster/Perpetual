...
func (p *cppPrompts) GetAnnotateConfig() map[string]interface{} {
	...
	result[config.K_AnnotateStage1Prompts] = [][4]string{
		{"(?i)^.*\\.(cpp|cxx|c\\+\\+|cppm)$", defaultAIAnnotatePrompt_CPP, defaultAIAnnotatePrompt_CPP_Short, defaultAIAnnotatePrompt_CPP_Tiny},
		{"(?i)^.*\\.c$", defaultAIAnnotatePrompt_C, defaultAIAnnotatePrompt_C_Short, defaultAIAnnotatePrompt_C_Tiny},
		{"(?i)^.*\\.(h|h\\+\\+|hpp|hh|tpp|ipp)$", defaultAIAnnotatePrompt_H_CPP, defaultAIAnnotatePrompt_H_CPP_Short, defaultAIAnnotatePrompt_H_CPP_Tiny},
