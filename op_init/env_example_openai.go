...
# Reasoning effort control, values are model dependent. Should work for models with reasoning capabilities.
...
OPENAI_REASONING_EFFORT_OP_EXPLAIN_STAGE1="high"
OPENAI_REASONING_EFFORT_OP_EXPLAIN_STAGE2="high"
