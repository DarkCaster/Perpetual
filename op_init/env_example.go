...
# Example for deepseek (https://www.deepseek.com/)

GENERIC_BASE_URL="https://api.deepseek.com/v1" # Required parameter for generic provider
GENERIC_API_KEY="<your api key goes here>"  # Provider-dependent option, required for deepseek example
GENERIC_ENABLE_STREAMING="0"
GENERIC_MAXTOKENS_FORMAT="OLD" # OLD using "max_tokens=<value>" format, NEW using "max_completion_tokens=<value>"
