...
# Worst and best-shot file-size to token-count conversion multipliers, used to predict failures due to context overflow
OLLAMA_CONTEXT_ESTIMATE_MULT="0.3" # equals to about 3.33 characters per token
OLLAMA_CONTEXT_ESTIMATE_MULT_BEST="0.23" # equals to about 4.34 characters per token
