...
const defaultAIAnnotatePrompt_Go_Short = "Create a short summary for the GO source file in my next message. The summary should be up to 3 sentences long, and should include the package name.\n\nIf there are comments in the file marked as notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nPackage: `<package name>`\n\n<Description of what this file is used for, up to 3 sentences>"
...
const defaultAIAnnotatePrompt_Bat_Short = "Create a short summary for the Windows Batch script in my next message. The summary should be up to 3 sentences long. If there are comments in the file with notes for creating this summary, follow them strictly."
...
const defaultAIAnnotatePrompt_Cmake_Short = "Create a short summary for the CMake script in my next message. The summary should be up to 3 sentences long. If there are comments in the file with notes for creating this summary, follow them strictly."
...
const defaultAIAnnotatePrompt_Perl_Short = "Create a short summary for the Perl script in my next message. The summary should be up to 3 sentences long. If there are comments in the file with notes for creating this summary, follow them strictly."
...
const defaultAIAnnotatePrompt_C_Short = "Create a short summary for the C source file in my next message. The summary should be up to 3 sentences long. If there are comments in the file marked as notes for creating this summary, follow them strictly."
...
const defaultAIAnnotatePrompt_CPP_Short = "Create a short summary for the C++ source file in my next message. The summary should be up to 3 sentences long. If there are comments in the file marked as notes for creating this summary, follow them strictly."
...
const defaultAIAnnotatePrompt_H_CPP_Short = "Create a short summary for the C++ header file in my next message. The summary should be up to 3 sentences long. If there are comments in the file marked as notes for creating this summary, follow them strictly."
...
const defaultAIAnnotatePrompt_H_Short = "Create a short summary for the C header file in my next message. The summary should be up to 3 sentences long. If there are comments in the file marked as notes for creating this summary, follow them strictly."
...
const defaultAIAnnotatePrompt_CS_Short = "Create a short summary for the C# source file in my next message. The summary should be up to 3 sentences long, and should include the namespace.\n\nIf there are comments in the file marked as notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nNamespace: `<namespace>`\n\n<Description of what this file is used for, up to 3 sentences>"
...
const defaultAIAnnotatePrompt_S_Short = "Create a short summary for the assembly source file in my next message. The summary should be up to 3 sentences long. If there are comments in the file marked as notes for creating this summary, follow them strictly."
...
const defaultAIAnnotatePrompt_VBNet_Short = "Create a short summary for the VB.NET source file in my next message. The summary should be up to 3 sentences long, and should include the namespace.\n\nIf there are comments in the file marked as notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nNamespace: `<namespace>`\n\n<Description of what this file is used for, up to 3 sentences>"
...
const defaultAIAnnotatePrompt_Py3_Short = "Create a short summary for the Python 3 source file in my next message. The summary should be up to 3 sentences long, and should include the module name.\n\nIf there are comments in the file marked as notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nModule: `<module_name>`\n\n<Description of what this file is used for, up to 3 sentences>"
...
const defaultAIAnnotatePrompt_Xaml_Short = "Create a short summary for the XAML ui-markup file in my next message. The summary should be up to 3 sentences long."
...
const defaultAIAnnotatePrompt_VB6_Class_Short = "Create a short summary for the Visual Basic 6 class module in my next message. The summary should be up to 3 sentences long, and should include the class name.\n\nIf there are comments in the file marked as notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nClass: `<class name>`\n\n<Description of what this class is used for, up to 3 sentences>"
...
const defaultAIAnnotatePrompt_VB6_Form_Short = "Create a short summary for the Visual Basic 6 form in my next message. The summary should be up to 3 sentences long, and should include the form name.\n\nIf there are comments in the file marked as notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nForm: `<form name>`\n\n<Description of what this form is used for, up to 3 sentences>"
...
const defaultAIAnnotatePrompt_VB6_Module_Short = "Create a short summary for the Visual Basic 6 standard module in my next message. The summary should be up to 3 sentences long, and should include the module name.\n\nIf there are comments in the file marked as notes for creating this summary, follow them strictly. Otherwise, use the following template:\n\nModule: `<module name>`\n\n<Description of what this module is used for, up to 3 sentences>"
...
func getDefaultAnnotateConfigTemplate() map[string]interface{} {
	...
	result[config.K_AnnotateContextSavingFilesCount1] = 1000
	result[config.K_AnnotateContextSavingFilesCount2] = 2000
