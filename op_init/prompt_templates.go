...
func getDefaultImplementConfigTemplate() map[string]interface{} {
	...
	result[config.K_ImplementTaskStage1AnalysisPrompt] = "Below are the tasks that need to be implemented. Review the tasks and the project description that was provided to you and create a list of filenames from the project description that you will need to see to implement the tasks. Place each filename in <filename></filename> tags. The tasks are:"
	...
	result[config.K_ImplementTaskStage3PlanningPrompt] = "Below are the tasks that need to be implemented. Study all the source code provided to you and create a list of file names that will be changed or created by you as a result of implementing the tasks. Place each filename in <filename></filename> tags."
	result[config.K_ImplementTaskStage3PlanningJsonModePrompt] = "Below are the tasks that need to be implemented. Study all the source code provided to you and create a list of files that will be changed or created by you as a result of implementing the tasks."
